...
class TestClient:
    ...
    @parametrize
    def test_method_get_root(self, client: AlbotAPISDK) -> None:
        client_ = client.get_root()
        assert_matches_type(object, client_, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_root(self, client: AlbotAPISDK) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_root(self, client: AlbotAPISDK) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_root(self, async_client: AsyncAlbotAPISDK) -> None:
        client = await async_client.get_root()
        assert_matches_type(object, client, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_root(self, async_client: AsyncAlbotAPISDK) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_root(self, async_client: AsyncAlbotAPISDK) -> None:
