...
class AlbotAPISDK(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous AlbotAPISDK client instance.

        This automatically infers the `api_key` argument from the `ALBOT_API_SDK_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("ALBOT_API_SDK_API_KEY")
        if api_key is None:
            raise AlbotApisdkError(
                "The api_key client option must be set either by passing api_key to the client or by setting the ALBOT_API_SDK_API_KEY environment variable"
            )
        ...
        custom_headers_env = os.environ.get("ALBOT_API_SDK_CUSTOM_HEADERS")
...
class AsyncAlbotAPISDK(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncAlbotAPISDK client instance.
